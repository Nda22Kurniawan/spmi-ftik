...
<div class="row">
    <div class="col">
        <div class="alert alert-danger" role="alert">
            ...
            @endif
            <hr>
            <p>Menghapus element dapat berakibat terhapusnya <b>{{ $element->count_berkas }}</b> dokumen yang telah
                disimpan pada folder element dan score pencapaian yang telah diraih.</p>
